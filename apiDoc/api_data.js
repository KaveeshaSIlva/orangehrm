define({ "api": [
  ...
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/7-change-leave-request-status-end-point.php",
    "groupTitle": "User",
  ...
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "OrangeHRMVersion",
            "description": "<p>OrangeHRM Version.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/get-about-end-point.php",
    "groupTitle": "User",
    "description": "<p>Support access using OAuth2 access token created with <code>client_credentials</code> and <code>password</code> grant type</p> <p>Required scope: <code>admin</code></p> <p>Required scope by grant type;</p> <ul> <li><code>client_credentials</code>: No need to request scopes. By default grant only for <code>admin</code> scope</li> <li><code>password</code>: Required <code>admin</code> scope <code>Since OrangeHRM 4.5</code></li> </ul>"
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/11-get-accessible-employees-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>"
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/5-leave-list-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>"
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/6-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>"
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/12-get-my-info-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>"
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/1-my-leave-entitlement-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "success": {
      "fields": {
  ...
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/2-my-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>"
  },
  {
    ...
    "group": "User",
    "version": "1.1.0",
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/4-save-my-multiple-day-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "group": "User",
    "version": "1.1.0",
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/3-save-my-single-day-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/10-save-subordinate-multiple-day-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/9-save-subordinate-single-day-leave-request-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "filename": "symfony/plugins/orangehrmRESTPlugin/doc/user/8-subordinate-leave-entitlement-end-point.php",
    "groupTitle": "User",
    "description": "<p>Required access using OAuth2 access token created with <code>password</code> grant type</p> <p>Required scope: <code>user</code></p> <p><code>Since OrangeHRM 4.5</code></p>",
    "success": {
      "fields": {
